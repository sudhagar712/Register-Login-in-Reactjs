  ...
  return (
    <>
      <div className="bg-white rounded-lg shadow-lg p-8 w-full mx-auto my-16 max-w-md">
        <h2 className="text-xl font-bold text-blue-500 mb-6 text-center">Welcome to SignUp</h2>
        <form onSubmit={handleSubmit}>
          <div className="mb-4">
            ...
            <input
              ...
              className="mt-1 p-2 w-full border rounded-md text-gray-800 outline-none shadow-lg"
            />
